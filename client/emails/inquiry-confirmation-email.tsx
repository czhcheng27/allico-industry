...
function InquiryConfirmationEmail({
  ...
  const previewText = `We received your ${formName} inquiry`;
        ...
        <Container style={container}>
          ...
          <Section style={contentSection}>
            ...
            <Text style={paragraph}>
              This is a confirmation that we received your {formName} inquiry.
            ...
            <Text style={paragraph}>
              If you need to add more details, you can reply to this email and
...
export { InquiryConfirmationEmail };
