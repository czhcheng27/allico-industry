...
export const categories: Category[] = [
  {
    ...
    name: "Towing",
    shortName: "Towing",
    description: "Recovery chains, straps, wire rope and towing accessories.",
    cardImage: images.categoryTowing,
    icon: "auto_towing",
    subcategories: [
  ...
  },
  {
    ...
    name: "Cargo Control",
    shortName: "Cargo",
    description: "Securement systems for transport, tie-down, and flatbed jobs.",
    cardImage: images.categoryCargo,
    icon: "inventory_2",
    subcategories: [
      { slug: "binder-chains-transport-chain", name: "Binder Chains/ Transport Chain" },
      { slug: "winch-and-ratchet-straps", name: "Winch and Ratchet Straps" },
      { slug: "cargo-control-accessories", name: "Cargo Control Accessories" },
    ],
  },
  {
    ...
    description: "Lift, transport, and mill chain grades for heavy industries.",
    cardImage: images.categoryIndustrial,
    icon: "link",
    subcategories: [
      { slug: "mill-chain", name: "Mill Chain" },
      {
        slug: "g80-g100-g120-overhead-lifting-chain",
        name: "G-80, G-100 and G-120 Overhead Lifting Chain",
      },
      { slug: "g70-transport-chain", name: "G-70 Transport Chain" },
    ],
  },
  {
    slug: "hooks-and-accessories",
    name: "Hooks and Accessories",
    shortName: "Hooks",
    description: "High-strength hooks, shackles, couplers, and rigging hardware.",
    cardImage: images.categoryHooks,
    icon: "anchor",
    subcategories: [],
  },
];
...
export const products: Product[] = [
  ...
  },
  {
    ...
    detail: {
      ...
      thumbImages: [images.g100Main, images.foundryHook, images.shackle, images.hammerlock],
      relatedSlugs: ["g100-eye-foundry-hook", "forged-anchor-shackle", "hammerlock-coupling-link"],
    },
  },
  {
...
export function getProductByCategoryAndSku(category: CategorySlug, sku: string) {
  return products.find((product) => product.category === category && product.sku === sku);
}
...
export function getRelatedProducts(product: Product, max = 3) {
  const relatedFromDetail = product.detail?.relatedSlugs ?? [];
  const picked = relatedFromDetail
    .map((slug) => getProductBySlug(slug))
